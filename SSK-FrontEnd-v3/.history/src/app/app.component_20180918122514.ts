...
export class AppComponent implements  OnInit, AfterViewInit {
  ...
  constructor(private sskService: SskServicesService, private router: Router, private location: Location,
              private elastiServ: ElastichsearchServicesService, private glossaryContent: ContentComponent ) {}
  ...
  toGlossary(item: string) {
    ...
    setTimeout(() => {
      this.glossaryContent.data = this.elastiServ.glossaryChange(item);
    }, 2000);
  }
}
