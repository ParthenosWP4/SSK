 ...
 *         &lt;/choice>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}outputRendition" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    ...
    "outputRendition",
    "modelSequencesAndModels"
})
@XmlRootElement(name = "modelGrp")
public class ModelGrp implements Serializable
{
    ...
    protected OutputRendition outputRendition;
    @XmlElements({
        @XmlElement(name = "modelSequence", type = ModelSequence.class),
        @XmlElement(name = "model", type = Model.class)
    })
    protected List<Serializable> modelSequencesAndModels;
    ...
    /**
     * Obtient la valeur de la propriété outputRendition.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public OutputRendition getOutputRendition() {
        return outputRendition;
    }

    /**
     * Définit la valeur de la propriété outputRendition.
     * 
     * @param value
     *     allowed object is
     *     {@link OutputRendition }
     *     
     */
    public void setOutputRendition(OutputRendition value) {
        this.outputRendition = value;
    }

    /**
     * Gets the value of the modelSequencesAndModels property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the modelSequencesAndModels property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getModelSequencesAndModels().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getModelSequencesAndModels() {
        if (modelSequencesAndModels == null) {
            modelSequencesAndModels = new ArrayList<Serializable>();
        }
        return this.modelSequencesAndModels;
    }
