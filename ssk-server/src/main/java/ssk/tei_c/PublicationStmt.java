...
@XmlType(name = "", propOrder = {
    "psAndAbs",
    "publishersAndDistributorsAndAuthorities"
})
    ...
    implements Serializable
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "distributor", type = Distributor.class),
    ...
    protected List<Serializable> publishersAndDistributorsAndAuthorities;
    ...
    /**
     * Gets the value of the publishersAndDistributorsAndAuthorities property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the publishersAndDistributorsAndAuthorities property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPublishersAndDistributorsAndAuthorities().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getPublishersAndDistributorsAndAuthorities() {
        if (publishersAndDistributorsAndAuthorities == null) {
            publishersAndDistributorsAndAuthorities = new ArrayList<Serializable>();
        }
        return this.publishersAndDistributorsAndAuthorities;
    }
