 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}cRefPattern" maxOccurs="unbounded"/>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}refState" maxOccurs="unbounded"/>
 *       &lt;/choice>
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "refState")
    protected List<RefState> refStates;
    @XmlElement(name = "cRefPattern")
    protected List<CRefPattern> cRefPatterns;
    @XmlElements({
    ...
    /**
     * Gets the value of the refStates property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the refStates property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRefStates().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RefState> getRefStates() {
        if (refStates == null) {
            refStates = new ArrayList<RefState>();
        }
        return this.refStates;
    }

    /**
     * Gets the value of the cRefPatterns property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cRefPatterns property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCRefPatterns().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CRefPattern> getCRefPatterns() {
        if (cRefPatterns == null) {
            cRefPatterns = new ArrayList<CRefPattern>();
        }
        return this.cRefPatterns;
    }
