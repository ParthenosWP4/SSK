 ...
 *         &lt;/choice>
 *         &lt;choice maxOccurs="unbounded" minOccurs="0">
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}content"/>
...
public class MacroSpec implements Serializable
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "valList", type = ValList.class)
    })
    protected List<Serializable> contentsAndValLists;
    ...
    /**
     * Gets the value of the contentsAndValLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the contentsAndValLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContentsAndValLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getContentsAndValLists() {
        if (contentsAndValLists == null) {
            contentsAndValLists = new ArrayList<Serializable>();
        }
        return this.contentsAndValLists;
    }
