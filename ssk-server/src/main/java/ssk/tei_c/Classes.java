 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}memberOf" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements Serializable
{
    ...
    protected List<MemberOf> memberOves;
     ...
     * 
     */
    public List<MemberOf> getMemberOves() {
        if (memberOves == null) {
            memberOves = new ArrayList<MemberOf>();
        }
