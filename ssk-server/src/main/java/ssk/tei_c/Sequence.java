 ...
 *       &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.contentPart" maxOccurs="unbounded"/>
 *       &lt;attGroup ref="{http://www.tei-c.org/ns/1.0}tei_att.repeatable.attributes"/>
 *       &lt;attGroup ref="{http://www.tei-c.org/ns/1.0}tei_att.global.attributes"/>
 *       &lt;attribute name="preserveOrder" type="{http://www.w3.org/2001/XMLSchema}boolean" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Sequence implements Serializable
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "alternate", type = Alternate.class),
        @XmlElement(name = "dataRef", type = DataRef.class),
        @XmlElement(name = "valList", type = ValList.class),
        @XmlElement(name = "textNode", type = TextNode.class),
        @XmlElement(name = "anyElement", type = AnyElement.class)
    })
    ...
    /**
     * Obtient la valeur de la propriété preserveOrder.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Définit la valeur de la propriété preserveOrder.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
