 ...
 *       &lt;attGroup ref="{http://www.tei-c.org/ns/1.0}tei_att.segLike.attributes"/>
    ...
    implements Serializable
{
    ...
    public List<String> getValueDatcats() {
        if (valueDatcats == null) {
            valueDatcats = new ArrayList<String>();
        }
