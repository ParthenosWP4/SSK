 ...
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}event"/>
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}listEvent"/>
 *         &lt;/choice>
...
public class ListEvent implements Serializable
{
    ...
    protected List<Serializable> eventsAndListEvents;
    @XmlElements({
    ...
    /**
     * Gets the value of the eventsAndListEvents property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the eventsAndListEvents property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEventsAndListEvents().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getEventsAndListEvents() {
        if (eventsAndListEvents == null) {
            eventsAndListEvents = new ArrayList<Serializable>();
        }
        return this.eventsAndListEvents;
    }
