    ...
    implements Serializable
{
    ...
    @XmlAttribute(name = "mainLang")
    protected String mainLang;
    @XmlAttribute(name = "otherLangs")
    protected List<String> otherLangs;
    ...
    /**
     * Obtient la valeur de la propriété mainLang.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété mainLang.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMainLang(String value) {
        this.mainLang = value;
    }

    /**
     * Gets the value of the otherLangs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the otherLangs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOtherLangs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getOtherLangs() {
        if (otherLangs == null) {
            otherLangs = new ArrayList<String>();
        }
