 ...
 *             &lt;enumeration value="sequenceOptional"/>
 *             &lt;enumeration value="sequenceOptionalRepeatable"/>
 *             &lt;enumeration value="sequenceRepeatable"/>
 *           &lt;/restriction>
 *         &lt;/simpleType>
 *       &lt;/attribute>
...
public class ClassRef implements Serializable
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the excepts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getExcepts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
