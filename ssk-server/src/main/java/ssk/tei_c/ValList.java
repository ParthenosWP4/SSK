 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}valItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="type" default="open">
 *         &lt;simpleType>
...
@XmlRootElement(name = "valList")
public class ValList implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "valItem")
    protected List<ValItem> valItems;
    ...
    /**
     * Gets the value of the valItems property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the valItems property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getValItems().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ValItem> getValItems() {
        if (valItems == null) {
