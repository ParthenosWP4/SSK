...
public class CorrespDesc implements Serializable
{
    ...
    protected List<Serializable> notesAndCorrespActionsAndCorrespContexts;
     ...
     * 
     */
    public List<Serializable> getNotesAndCorrespActionsAndCorrespContexts() {
        if (notesAndCorrespActionsAndCorrespContexts == null) {
            notesAndCorrespActionsAndCorrespContexts = new ArrayList<Serializable>();
        }
