 ...
 *           &lt;/choice>
 *         &lt;/sequence>
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.divBottom" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Group implements Serializable
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "text", namespace = "http://www.tei-c.org/ns/1.0", type = JAXBElement.class, required = false),
    ...
    protected List<Serializable> meetingsAndBylinesAndDatelines;
     ...
     * 
     */
    public List<Serializable> getMeetingsAndBylinesAndDatelines() {
