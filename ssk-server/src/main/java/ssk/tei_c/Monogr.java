 ...
 *           &lt;/sequence>
 *           &lt;sequence>
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}authority"/>
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}idno"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}availability" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.noteLike" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}tei_model.ptrLike"/>
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}editor"/>
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}sponsor"/>
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}funder"/>
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}respStmt"/>
 *           &lt;/choice>
 *         &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    ...
    "imprintsAndExtentsAndBiblScopes"
})
@XmlRootElement(name = "monogr")
public class Monogr implements Serializable
{
    ...
    protected List<Serializable> authorsAndEditorsAndMeetings;
    @XmlElements({
        @XmlElement(name = "imprint", required = true, type = Imprint.class),
        @XmlElement(name = "extent", required = true, type = Extent.class),
        @XmlElement(name = "biblScope", required = true, type = BiblScope.class)
    })
    protected List<Serializable> imprintsAndExtentsAndBiblScopes;
     ...
     * 
     */
    public List<Serializable> getAuthorsAndEditorsAndMeetings() {
        if (authorsAndEditorsAndMeetings == null) {
            authorsAndEditorsAndMeetings = new ArrayList<Serializable>();
        }
        return this.authorsAndEditorsAndMeetings;
    }

    /**
     * Gets the value of the imprintsAndExtentsAndBiblScopes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the imprintsAndExtentsAndBiblScopes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getImprintsAndExtentsAndBiblScopes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getImprintsAndExtentsAndBiblScopes() {
        if (imprintsAndExtentsAndBiblScopes == null) {
            imprintsAndExtentsAndBiblScopes = new ArrayList<Serializable>();
        }
        return this.imprintsAndExtentsAndBiblScopes;
    }
