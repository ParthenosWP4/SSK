 ...
 *         &lt;/choice>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}climate" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Climate implements Serializable
{
    ...
    protected List<Climate> climates;
    ...
    /**
     * Gets the value of the climates property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the climates property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClimates().add(newItem);
     * </pre>
     * 
     * 
     * <p>
