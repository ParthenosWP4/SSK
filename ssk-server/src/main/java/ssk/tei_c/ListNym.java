 ...
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}nym"/>
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}listNym"/>
 *         &lt;/choice>
...
@XmlRootElement(name = "listNym")
public class ListNym implements Serializable
{
    ...
    @XmlElements({
        @XmlElement(name = "nym", type = Nym.class),
        @XmlElement(name = "listNym", type = ListNym.class)
    })
    protected List<Serializable> nymsAndListNyms;
    @XmlElements({
    ...
    /**
     * Gets the value of the nymsAndListNyms property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nymsAndListNyms property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNymsAndListNyms().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getNymsAndListNyms() {
        if (nymsAndListNyms == null) {
            nymsAndListNyms = new ArrayList<Serializable>();
        }
        return this.nymsAndListNyms;
    }
