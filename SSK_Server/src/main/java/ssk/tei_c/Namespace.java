 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}tagUsage" maxOccurs="unbounded"/>
 *       &lt;/sequence>
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "tagUsage", required = true)
    protected List<TagUsage> tagUsages;
    ...
    /**
     * Gets the value of the tagUsages property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tagUsages property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTagUsages().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<TagUsage> getTagUsages() {
        if (tagUsages == null) {
            tagUsages = new ArrayList<TagUsage>();
        }
