 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}attRef"/>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}attDef"/>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}attList"/>
 *       &lt;/choice>
 *       &lt;attGroup ref="{http://www.tei-c.org/ns/1.0}tei_att.global.attributes"/>
 *       &lt;attribute name="org" default="group">
 *         &lt;simpleType>
...
@XmlType(name = "", propOrder = {
    "attRevesAndAttDevesAndAttLists"
})
@XmlRootElement(name = "attList")
public class AttList implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElements({
        @XmlElement(name = "attRef", type = AttRef.class),
        @XmlElement(name = "attDef", type = AttDef.class),
        @XmlElement(name = "attList", type = AttList.class)
    })
    protected List<Serializable> attRevesAndAttDevesAndAttLists;
    ...
    /**
     * Gets the value of the attRevesAndAttDevesAndAttLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the attRevesAndAttDevesAndAttLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAttRevesAndAttDevesAndAttLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getAttRevesAndAttDevesAndAttLists() {
        if (attRevesAndAttDevesAndAttLists == null) {
            attRevesAndAttDevesAndAttLists = new ArrayList<Serializable>();
        }
        return this.attRevesAndAttDevesAndAttLists;
    }
