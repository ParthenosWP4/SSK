 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}langKnown" maxOccurs="unbounded"/>
 *       &lt;/choice>
...
@XmlRootElement(name = "langKnowledge")
public class LangKnowledge implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "langKnown")
    protected List<LangKnown> langKnowns;
    protected Ab ab;
    protected P p;
    ...
    /**
     * Gets the value of the langKnowns property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the langKnowns property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLangKnowns().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LangKnown> getLangKnowns() {
        if (langKnowns == null) {
            langKnowns = new ArrayList<LangKnown>();
        }
        return this.langKnowns;
    }
