 ...
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}org"/>
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}listOrg"/>
 *         &lt;/choice>
...
@XmlRootElement(name = "listOrg")
public class ListOrg implements Serializable
{
    ...
    protected List<Serializable> orgsAndListOrgs;
    @XmlElements({
    ...
    /**
     * Gets the value of the orgsAndListOrgs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orgsAndListOrgs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrgsAndListOrgs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getOrgsAndListOrgs() {
        if (orgsAndListOrgs == null) {
            orgsAndListOrgs = new ArrayList<Serializable>();
        }
        return this.orgsAndListOrgs;
    }
