...
@XmlType(name = "", propOrder = {
    "classCodesAndCatRevesAndKeywords"
})
public class TextClass implements Serializable
{
    ...
    protected List<Serializable> classCodesAndCatRevesAndKeywords;
    ...
    /**
     * Gets the value of the classCodesAndCatRevesAndKeywords property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the classCodesAndCatRevesAndKeywords property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClassCodesAndCatRevesAndKeywords().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getClassCodesAndCatRevesAndKeywords() {
        if (classCodesAndCatRevesAndKeywords == null) {
            classCodesAndCatRevesAndKeywords = new ArrayList<Serializable>();
        }
        return this.classCodesAndCatRevesAndKeywords;
    }
