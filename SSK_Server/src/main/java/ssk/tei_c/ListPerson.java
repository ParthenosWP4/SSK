 ...
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}tei_model.personLike"/>
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}listPerson"/>
 *         &lt;/choice>
 *         &lt;choice maxOccurs="unbounded" minOccurs="0">
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}relation"/>
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}listRelation"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    "heads",
    "teiModelPersonLikesAndListPersons",
    "relationsAndListRelations"
})
...
public class ListPerson implements Serializable
{
    ...
    protected List<Serializable> teiModelPersonLikesAndListPersons;
    @XmlElements({
        @XmlElement(name = "relation", type = Relation.class),
        @XmlElement(name = "listRelation", type = ListRelation.class)
    })
    protected List<Serializable> relationsAndListRelations;
    ...
    /**
     * Gets the value of the teiModelPersonLikesAndListPersons property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the teiModelPersonLikesAndListPersons property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTeiModelPersonLikesAndListPersons().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getTeiModelPersonLikesAndListPersons() {
        if (teiModelPersonLikesAndListPersons == null) {
            teiModelPersonLikesAndListPersons = new ArrayList<Serializable>();
        }
        return this.teiModelPersonLikesAndListPersons;
    }

    /**
     * Gets the value of the relationsAndListRelations property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the relationsAndListRelations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRelationsAndListRelations().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getRelationsAndListRelations() {
        if (relationsAndListRelations == null) {
            relationsAndListRelations = new ArrayList<Serializable>();
        }
        return this.relationsAndListRelations;
    }
