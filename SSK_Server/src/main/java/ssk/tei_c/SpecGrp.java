...
@XmlType(name = "", propOrder = {
    "moduleSpecsAndSpecGrpsAndSpecGrpReves"
})
@XmlRootElement(name = "specGrp")
public class SpecGrp implements Serializable
{
    ...
    protected List<Serializable> moduleSpecsAndSpecGrpsAndSpecGrpReves;
    ...
    /**
     * Gets the value of the moduleSpecsAndSpecGrpsAndSpecGrpReves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the moduleSpecsAndSpecGrpsAndSpecGrpReves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getModuleSpecsAndSpecGrpsAndSpecGrpReves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getModuleSpecsAndSpecGrpsAndSpecGrpReves() {
        if (moduleSpecsAndSpecGrpsAndSpecGrpReves == null) {
            moduleSpecsAndSpecGrpsAndSpecGrpReves = new ArrayList<Serializable>();
        }
        return this.moduleSpecsAndSpecGrpsAndSpecGrpReves;
    }
