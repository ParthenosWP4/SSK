    ...
    implements Serializable
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "funder", type = Funder.class),
        @XmlElement(name = "principal", type = Principal.class)
    })
    protected List<Serializable> authorsAndEditorsAndRespStmts;
    ...
    /**
     * Gets the value of the authorsAndEditorsAndRespStmts property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the authorsAndEditorsAndRespStmts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAuthorsAndEditorsAndRespStmts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getAuthorsAndEditorsAndRespStmts() {
        if (authorsAndEditorsAndRespStmts == null) {
            authorsAndEditorsAndRespStmts = new ArrayList<Serializable>();
        }
        return this.authorsAndEditorsAndRespStmts;
    }
