...
@XmlType(name = "", propOrder = {
    "teiModelPtrLikesAndPSAndAbs"
})
@XmlRootElement(name = "correspContext")
public class CorrespContext implements Serializable
{
    ...
    protected List<Serializable> teiModelPtrLikesAndPSAndAbs;
    ...
    /**
     * Gets the value of the teiModelPtrLikesAndPSAndAbs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the teiModelPtrLikesAndPSAndAbs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTeiModelPtrLikesAndPSAndAbs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getTeiModelPtrLikesAndPSAndAbs() {
        if (teiModelPtrLikesAndPSAndAbs == null) {
            teiModelPtrLikesAndPSAndAbs = new ArrayList<Serializable>();
        }
        return this.teiModelPtrLikesAndPSAndAbs;
    }
