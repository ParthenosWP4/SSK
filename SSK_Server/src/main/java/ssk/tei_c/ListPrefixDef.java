 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}prefixDef"/>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}listPrefixDef"/>
 *       &lt;/choice>
...
@XmlType(name = "", propOrder = {
    "prefixDevesAndListPrefixDeves"
})
public class ListPrefixDef implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElements({
        @XmlElement(name = "prefixDef", type = PrefixDef.class),
        @XmlElement(name = "listPrefixDef", type = ListPrefixDef.class)
    })
    protected List<Serializable> prefixDevesAndListPrefixDeves;
    ...
    /**
     * Gets the value of the prefixDevesAndListPrefixDeves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prefixDevesAndListPrefixDeves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrefixDevesAndListPrefixDeves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getPrefixDevesAndListPrefixDeves() {
        if (prefixDevesAndListPrefixDeves == null) {
            prefixDevesAndListPrefixDeves = new ArrayList<Serializable>();
        }
        return this.prefixDevesAndListPrefixDeves;
    }
