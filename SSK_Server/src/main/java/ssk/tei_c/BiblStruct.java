 ...
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}relatedItem"/>
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}citedRange"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    "analytics",
    "monogrsAndSeries",
    "notesAndTeiModelPtrLikesAndRelatedItems"
})
@XmlRootElement(name = "biblStruct")
public class BiblStruct implements Serializable
{
    ...
    protected List<Serializable> monogrsAndSeries;
    @XmlElementRefs({
    ...
    protected List<Serializable> notesAndTeiModelPtrLikesAndRelatedItems;
     ...
     * 
     */
    public List<Serializable> getMonogrsAndSeries() {
        if (monogrsAndSeries == null) {
            monogrsAndSeries = new ArrayList<Serializable>();
        }
        return this.monogrsAndSeries;
    }

    /**
     * Gets the value of the notesAndTeiModelPtrLikesAndRelatedItems property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the notesAndTeiModelPtrLikesAndRelatedItems property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNotesAndTeiModelPtrLikesAndRelatedItems().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getNotesAndTeiModelPtrLikesAndRelatedItems() {
        if (notesAndTeiModelPtrLikesAndRelatedItems == null) {
            notesAndTeiModelPtrLikesAndRelatedItems = new ArrayList<Serializable>();
        }
        return this.notesAndTeiModelPtrLikesAndRelatedItems;
    }
