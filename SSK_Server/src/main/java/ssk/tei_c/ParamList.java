 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}paramSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements Serializable
{
    ...
    /**
     * Gets the value of the paramSpecs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the paramSpecs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getParamSpecs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<ParamSpec> getParamSpecs() {
        if (paramSpecs == null) {
            paramSpecs = new ArrayList<ParamSpec>();
        }
