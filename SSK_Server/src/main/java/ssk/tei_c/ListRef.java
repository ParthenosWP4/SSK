 ...
 *       &lt;choice>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}ptr" maxOccurs="unbounded"/>
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}ref" maxOccurs="unbounded"/>
 *       &lt;/choice>
...
@XmlRootElement(name = "listRef")
public class ListRef implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "ref")
    protected List<Ref> reves;
    @XmlElement(name = "ptr")
    protected List<Ptr> ptrs;
     ...
     * 
     */
    public List<Ref> getReves() {
        if (reves == null) {
            reves = new ArrayList<Ref>();
        }
        return this.reves;
    }

    /**
     * Gets the value of the ptrs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ptrs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<Ptr> getPtrs() {
        if (ptrs == null) {
            ptrs = new ArrayList<Ptr>();
        }
        return this.ptrs;
    }
