    ...
    implements Serializable
{
    ...
    protected List<Serializable> editorsAndRespStmts;
    @XmlElements({
        @XmlElement(name = "idno", type = Idno.class),
        @XmlElement(name = "biblScope", type = BiblScope.class)
    })
    protected List<Serializable> idnosAndBiblScopes;
    @XmlElements({
    ...
    /**
     * Gets the value of the editorsAndRespStmts property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the editorsAndRespStmts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEditorsAndRespStmts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getEditorsAndRespStmts() {
        if (editorsAndRespStmts == null) {
            editorsAndRespStmts = new ArrayList<Serializable>();
        }
        return this.editorsAndRespStmts;
    }
     ...
     * 
     */
    public List<Serializable> getIdnosAndBiblScopes() {
        if (idnosAndBiblScopes == null) {
            idnosAndBiblScopes = new ArrayList<Serializable>();
        }
