...
public class Epigraph implements Serializable
{
    ...
    protected java.util.List<Serializable> lsAndPSAndAbs;
    ...
    /**
     * Gets the value of the lsAndPSAndAbs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the lsAndPSAndAbs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLSAndPSAndAbs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public java.util.List<Serializable> getLSAndPSAndAbs() {
        if (lsAndPSAndAbs == null) {
            lsAndPSAndAbs = new ArrayList<Serializable>();
        }
        return this.lsAndPSAndAbs;
    }
