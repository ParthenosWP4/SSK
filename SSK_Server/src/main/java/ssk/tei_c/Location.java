 ...
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.placeNamePart"/>
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.offsetLike"/>
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.measureLike"/>
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.addressLike"/>
...
public class Location implements Serializable
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "measureGrp", type = MeasureGrp.class),
        @XmlElement(name = "geo", type = Geo.class),
    ...
    protected List<Serializable> descsAndLabelsAndPlaceNames;
     ...
     * 
     */
    public List<Serializable> getDescsAndLabelsAndPlaceNames() {
        if (descsAndLabelsAndPlaceNames == null) {
            descsAndLabelsAndPlaceNames = new ArrayList<Serializable>();
        }
