...
@XmlType(name = "", propOrder = {
    "psAndAbs",
    "datesAndTimesAndEmails"
})
@XmlRootElement(name = "correspAction")
public class CorrespAction implements Serializable
{
    ...
    protected List<Serializable> datesAndTimesAndEmails;
    ...
    /**
     * Gets the value of the datesAndTimesAndEmails property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the datesAndTimesAndEmails property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDatesAndTimesAndEmails().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getDatesAndTimesAndEmails() {
        if (datesAndTimesAndEmails == null) {
            datesAndTimesAndEmails = new ArrayList<Serializable>();
        }
        return this.datesAndTimesAndEmails;
    }
