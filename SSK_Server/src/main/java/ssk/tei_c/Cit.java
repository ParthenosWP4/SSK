 ...
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}tei_model.egLike"/>
...
public class Cit implements Serializable
{
    ...
    protected List<Serializable> quotesAndCitsAndSaids;
    ...
    /**
     * Gets the value of the quotesAndCitsAndSaids property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the quotesAndCitsAndSaids property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQuotesAndCitsAndSaids().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getQuotesAndCitsAndSaids() {
        if (quotesAndCitsAndSaids == null) {
            quotesAndCitsAndSaids = new ArrayList<Serializable>();
        }
        return this.quotesAndCitsAndSaids;
    }
