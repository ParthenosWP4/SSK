...
public class Abstract implements Serializable
{
    ...
    protected java.util.List<Serializable> psAndAbsAndLists;
    ...
    /**
     * Gets the value of the psAndAbsAndLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the psAndAbsAndLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPSAndAbsAndLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public java.util.List<Serializable> getPSAndAbsAndLists() {
        if (psAndAbsAndLists == null) {
            psAndAbsAndLists = new ArrayList<Serializable>();
        }
        return this.psAndAbsAndLists;
    }
