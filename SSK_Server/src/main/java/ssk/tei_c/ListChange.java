 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}change"/>
 *       &lt;/choice>
...
@XmlType(name = "", propOrder = {
    "listChangesAndChanges"
})
@XmlRootElement(name = "listChange")
public class ListChange implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElements({
        @XmlElement(name = "listChange", type = ListChange.class),
        @XmlElement(name = "change", type = Change.class)
    })
    protected List<Serializable> listChangesAndChanges;
    ...
    /**
     * Gets the value of the listChangesAndChanges property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listChangesAndChanges property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getListChangesAndChanges().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Serializable> getListChangesAndChanges() {
        if (listChangesAndChanges == null) {
            listChangesAndChanges = new ArrayList<Serializable>();
        }
        return this.listChangesAndChanges;
    }

    /**
     * Obtient la valeur de la propriété ordered.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Définit la valeur de la propriété ordered.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
