 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}nym" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Nym implements Serializable
{
    ...
    /**
     * Gets the value of the nyms property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nyms property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
