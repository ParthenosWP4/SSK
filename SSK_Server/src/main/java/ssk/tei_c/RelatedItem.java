...
public class RelatedItem implements Serializable
{
    ...
    protected JAXBElement<?> teiModelPtrLike;
    ...
    /**
     * Obtient la valeur de la propriété teiModelPtrLike.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<?> getTeiModelPtrLike() {
        return teiModelPtrLike;
    }

    /**
     * Définit la valeur de la propriété teiModelPtrLike.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Ref }{@code >}
     ...
     *     
     */
    public void setTeiModelPtrLike(JAXBElement<?> value) {
        this.teiModelPtrLike = value;
    }
