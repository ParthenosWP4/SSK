...
export class ScenarioComponent implements OnInit, AfterViewInit {
          ...
          this.elasticServices.getScenariosID().forEach((obj) => {
            this.elasticServices.getScenarioDetails(obj._id).subscribe(
              detailsResult => {
                ...
                console.log('this.scenarioDetails =', this.scenarioDetails);
              ...
              () => {
                ...
                if (this.scenarioDetails['id'] === this.scenarioId) {
                  ...
                  // console.log('this.scenarioElt =', this.scenarioElt);
  ...
  setCurrentScenario() {
    ...
    console.log('scenarioElt =', this.scenarioElt);
    console.log('scenarioTitle =', this.scenarioTitle);
